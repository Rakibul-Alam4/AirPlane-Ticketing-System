    ...
    for(int i=1;i<4;){
    	...
    	if(user.equals("1") && password.equals("1")){
    		...
    		for(int x=1; x==1;){
    			...
    			System.out.println("________WELCOME TO GK AIRLINE_________");
    			System.out.println("______________________________________");
    			...
    			for(x=1; x==1;){
					...
					if (choice.equals("1")){
    					...
    					System.out.println("________________________________________________________");
						System.out.println(" 1.)DHAKA-SYLHET       | 6000BDT |   "+available[1]+"   ");
    					System.out.println(" 2.)SAIDPUR-CHATTAGRAM | 8000BDT |   "+available[2]+"   ");
    					System.out.println(" 3.)JESSHORE-DHAKA     | 11000BDT|   "+available[3]+"   ");
    					System.out.println(" 4.)DHAKA-CHATTAGRAM   | 7000BDT |   "+available[4]+"   ");
    					System.out.println(" 5.)DHAKA-SAIDPUR      | 7500BDT |   "+available[5]+"   ");
    					System.out.println("________________________________________________________");
						System.out.println("________________________________________________________\n");
    					System.out.println("POLITICES MEMBER, STUDENT, & SENIOR CITIZEN with 20% DISCOUNT!!!\n");	
    					x=0;
					}
					...
					//if CHOICE is "2" proceed to Ticket Booking//
    					...
    					String dest[] = { " ", "DHAKA-SYLHET", "SAIDPUR-CHATTAGRAM", "JESSHORE-DHAKA", "DHAKA-CHATTAGRAM", "DHAKA-SAIDPUR "};
    					double fare[] = { 0,6000,8000,11000,7000,7500};
    					...
    					if(print==1){
    						...
    						System.out.println("FARE PRICE: BDT " + ticketD[z][0]);
						...
						for(x=1; x==1;){
								...
								for(int b=0;b<z;b++){
									if(search.equalsIgnoreCase(ticketS[b][0])){
	    								...
	    								System.out.println("FARE PRICE: BDT" + ticketD[b][0]);
										...
										if(ticketS[b][2].equals("x")){
	    									...
	    									for(x=1; x==1;){
	    										System.out.println("\nPASSENGER'S TOTAL FARE: BDT "+ticketD[b][2]);
	    										...
	    										if(change[b]<0){
	    											...
	    											System.out.println("CHANGE: BDT "+change[b]);
	    											System.out.println("");
	    											x=0;
	    										}
	    									}
    					...
    					search = in.readLine();
							...
							for(x=0; x<=z; x++){
								if(search.equalsIgnoreCase(ticketS[x][0])){
    								...
    								System.out.println("FARE PRICE: BDT" + ticketD[x][0]);
    								System.out.println("NO. OF PASSENGERS: " + ticketI[x][0]);
    								System.out.println("NO. OF PASSENGERS WITH DISCOUNT: " + ticketI[x][1]);
    								System.out.println("TOTAL FARE PRICE: BDT " + ticketD[x][2]);
    								if(ticketS[x][2].equals("x")){
    									System.out.println("PAY: BDT " +pay[x]);
    									System.out.println("CHANGE: BDT " +change[x]);
